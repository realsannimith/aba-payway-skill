...
| `merchant_auth` | string | — | Yes | The JSON-encoded object containing `mc_id`, `payee` encrypted using RSA public key encryption in chunks. The encrypted data is then concatenated and encoded in Base64 format. |
